...
# Mode 0 is default and shows diffuse lighting.
# Use mode 1 to force color per facet (if flattened, else per vertex). Need to set them, default are white.
# Use mode 2 to show forced global color. Need to set it, default is white.
# Use mode 3 to disable shadow but still use diffuse lighting
...
app.simulation.sun = [0.0, 20.0, 5.0]
